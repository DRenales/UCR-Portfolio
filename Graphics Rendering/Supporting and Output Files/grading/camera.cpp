...
{
    //TODO;
    vec2 CellCenter = this->Cell_Center(pixel_index);
    vec3 uC_x = this->horizontal_vector * CellCenter[0];
    vec3 vC_y = this->vertical_vector * CellCenter[1];
    return this->film_position + uC_x + vC_y;
}
